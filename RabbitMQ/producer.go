...
var (
	uri          = flag.String("uri", "amqp://admin:admin@124.221.127.168:5672/", "AMQP URI")
	exchangeName = flag.String("exchange", "qp_query_test", "Durable AMQP exchange name")
	exchangeType = flag.String("exchange-type", "direct", "Exchange type - direct|fanout|topic|x-custom")
	routingKey   = flag.String("key", "test-key", "AMQP routing key")
	body         = flag.String("body", "Hello World", "Body of message")
